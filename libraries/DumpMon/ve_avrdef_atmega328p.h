/**
 * @file ve_avrdef_atmega328p.h
 * @brief ATmega328P Register structure definitions
 * @author andrey
 * @date 20.12.2012
 * @copyright GNU Public License
 */
#ifndef AVRDEF_ATMEGA328P_H_
#define AVRDEF_ATMEGA328P_H_
 ...
 */
typedef struct _ATmega328P_AVR_PCICR
{
...
} ATmega328P_AVR_PCICR;
typedef ATmega328P_AVR_PCICR AVR_PCICR;		///< Pin Change Interrupt Control Register type
 ...
 */
typedef struct _ATmega328P_AVR_EIMSK
{
    bool int0 :1;				///< External Interrupt Request Enable
    bool int1 :1;				///< External Interrupt Request Enable
} ATmega328P_AVR_EIMSK, *AVRP_EIMSK;
typedef ATmega328P_AVR_EIMSK AVR_EIMSK;	///< External Interrupt Control Register type
 ...
 */
typedef struct _ATmega328P_AVR_EIFR
{
    volatile bool intf0 :1;				///< External Interrupt Flag
    volatile bool intf1 :1;				///< External Interrupt Flag
} ATmega328P_AVR_EIFR;
typedef ATmega328P_AVR_EIFR AVR_EIFR;	///< External Interrupt Flag Register type
 ...
 */
typedef struct _ATmega328P_AVR_MCUSR
{
...
} ATmega328P_AVR_MCUSR;
typedef ATmega328P_AVR_MCUSR AVR_MCUSR;	///< Microcontroller Unit Status Register type
...
typedef struct _AVR_MCUCR_BODS
{
    ...
    bool jtd   :1;						///< JTAG Interface Disable
} AVR_MCUCR_BODS;
 ...
 */
typedef struct _ATmega328P_AVR_EICRA
{
    unsigned char isc0 :2;					///< External Interrupt 0 Sense Control Bits
    unsigned char isc1 :2;					///< External Interrupt 1 Sense Control Bits
} ATmega328P_AVR_EICRA;
typedef ATmega328P_AVR_EICRA AVR_EICRA;		///< External Interrupt Control Register A type
 ...
 */
typedef struct _ATmega328P_AVR_ADMUX
{
    unsigned char mux :4;					///< Analog Channel and Gain Selection Bits
...
} ATmega328P_AVR_ADMUX;
typedef ATmega328P_AVR_ADMUX AVR_ADMUX;		///< Analog Multiplexer Selection Register type
