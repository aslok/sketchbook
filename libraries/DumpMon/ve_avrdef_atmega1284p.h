/**
 * @file ve_avrdef_atmega1284p.h
 * @brief ATmega1284P Register structure definitions
 * @author andrey
 * @date 20.12.2012
 * @copyright GNU Public License
 */
#ifndef AVRDEF_ATMEGA1284P_H_
#define AVRDEF_ATMEGA1284P_H_

/**
 * @addtogroup ATmega1284P
 * @{
 */
/**
 ...
 */
typedef struct _ATmega1284P_AVR_PCICR
{
...
} ATmega1284P_AVR_PCICR;
typedef ATmega1284P_AVR_PCICR AVR_PCICR;	///< Pin Change Interrupt Control Register type
 ...
 */
typedef struct _ATmega1284P_AVR_EIMSK
{
...
} ATmega1284P_AVR_EIMSK;
typedef ATmega1284P_AVR_EIMSK AVR_EIMSK;	///< External Interrupt Control Register type
 ...
 */
typedef struct _ATmega1284P_AVR_EIFR
{
...
} ATmega1284P_AVR_EIFR;
typedef ATmega1284P_AVR_EIFR AVR_EIFR;	///< External Interrupt Flag Register type
 ...
 */
typedef struct _AVR_MCUCR_BODS
{
    ...
    volatile unsigned char bods :2;		///< BOD Sleep
    volatile bool jtd   :1;				///< JTAG Interface Disable
} AVR_MCUCR_BODS;
typedef AVR_MCUCR_BODS AVR_MCUCR;		///< Microcontroller Unit Control Register type
 ...
 */
typedef struct _ATmega1284P_AVR_PRR1
{
    bool prtim3 :1;						///< Power Reduction Timer/Counter 3
} ATmega1284P_AVR_PRR1;
typedef ATmega1284P_AVR_PRR1 AVR_PRR1;	///< Power Reduction Register 1 type
 ...
 */
typedef struct _ATmega1284P_AVR_EICRA
{
...
} ATmega1284P_AVR_EICRA;
typedef ATmega1284P_AVR_EICRA AVR_EICRA;	///< External Interrupt Control Register A type
 ...
 */
typedef struct _ATmega1284P_AVR_PCIMASK
{
	...
	AVR_REG	  reserved[5];
	/// @endcond
	PCMSK_REG pcmsk3;			///< Pin Change Interrupt Mask Register
} ATmega1284P_AVR_PCIMASK;
typedef ATmega1284P_AVR_PCIMASK AVR_PCIMASK;	///< Pin Change Interrupt Mask registers structure type
 ...
 */
typedef struct _ATmega1284P_AVR_AMUX
{
...
} ATmega1284P_AVR_AMUX;
typedef ATmega1284P_AVR_AMUX AVR_AMUX;	///< Analog Multiplexer Registers structure type
