/**
 * @file ve_atmega644pa.h
 * @brief ATmega644PA Microcontroller specific definitions
 * @author andrey
 * @date 20.12.2012
 * @copyright GNU Public License
 */
#ifndef ATMEGA644PA_H_
#define ATMEGA644PA_H_

/**
 * @defgroup ATmega644PA ATmega644PA
 * @ingroup MCs
 * @brief ATmega164A/164PA/324A/324PA/644PA Support
 * @{
 */
/**
 * @brief ATmega644PA Registers structure
 */
typedef struct _ATMEGA644PA_AVR_DEV {
...
typedef ATMEGA644PA_AVR_DEV AVR_DEV;	///< ATmega644PA Registers structure type
typedef ATMEGA644PA_AVR_DEV* AVRP_DEV;	///< Pointer to ATmega644PA Registers structure type
