 ...
 *
 *
Sketch uses 7,128 bytes (49.7%) of program storage space. Maximum is 14,336 bytes.
Global variables use 242 bytes (23.6%) of dynamic memory, leaving 782 bytes for local variables. Maximum is 1,024 bytes.
 */
...
void setup(){
  lcd = new cyr_lcd7x4(pinout, dig_pinout, pinout_anode, dig_pinout_anode, brightness);
}
